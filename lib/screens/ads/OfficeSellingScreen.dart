...
class OfficeSellingScreen extends StatefulWidget {
  @override
  _OfficeSellingScreenState createState() => _OfficeSellingScreenState();
}

class _OfficeSellingScreenState extends State<OfficeSellingScreen> {
  ...
  Widget _buildOfficeTypeField() {
    return Padding(
      ...
      child: DropdownButtonFormField<String>(
        ...
        items: [
          DropdownMenuItem(value: 'Open Plan', child: Text('Open Plan')),
          DropdownMenuItem(value: 'Private Offices', child: Text('Private Offices')),
          DropdownMenuItem(value: 'Coworking Space', child: Text('Coworking Space')),
          DropdownMenuItem(value: 'Meeting Rooms', child: Text('Meeting Rooms')),
        ],
        onChanged: (value) {
          setState(() {
            _officeType = value;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: AppColors.primaryDarkColor,
        title: Text('Sell Your Office', style: TextStyle(color: Colors.white)),
      ),
