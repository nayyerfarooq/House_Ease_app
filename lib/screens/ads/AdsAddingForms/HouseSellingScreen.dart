...
import 'package:shift_ease_fyp/Controllers/HouseSellingAdController.dart';
...
class HouseSellingScreen extends StatefulWidget {
  @override
  State<HouseSellingScreen> createState() => _HouseSellingScreenState();
}

class _HouseSellingScreenState extends State<HouseSellingScreen> {
  final HouseSellingController controller = Get.put(HouseSellingController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Sell Your House', style: TextStyle(color: AppColors.accentColor)),
      ),
  ...
  Widget _buildFormFields() {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            _buildDropdownField('House Type', controller.houseType, [
              'Detached House', 'Semi-Detached House', 'Townhouse', 'Apartment', 'Penthouse', 'Bungalow',
            ]),
            _buildInputField(TextInputType.number,'Built Year', controller.builtYear, Icons.calendar_today),
