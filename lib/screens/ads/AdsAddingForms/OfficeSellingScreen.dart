...
import 'package:shift_ease_fyp/Controllers/OfficeSellingControllers.dart';
...
class OfficeSellingScreen extends StatefulWidget {
  @override
  State<OfficeSellingScreen> createState() => _OfficeSellingScreenState();
}

class _OfficeSellingScreenState extends State<OfficeSellingScreen> {
  final OfficeSellingController controller = Get.put(OfficeSellingController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Rent Your Office', style: TextStyle(color: AppColors.accentColor)),
      ),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildDropdownField('Office Type', controller.officeType, [
              'Open Plan', 'Private Offices',
              'CoWorking Space','Meeting Rooms','Others'
            ]),
            _buildInputField(TextInputType.number,'Floor Number', controller.floorNumber, Icons.numbers),
            _buildInputField(TextInputType.text,'Building Type', controller.buildingType, Icons.apartment),
